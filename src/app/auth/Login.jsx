...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post('https://desarrollo-aquasmart-1zm8.onrender.com/api/users/login', {
                document,
                password
            });
    ...
    const handleTokenSubmit = async () => {
        try {
            const response = await axios.post('https://desarrollo-aquasmart-1zm8.onrender.com/api/users/validate-otp', {
                document,
                otp
            });
